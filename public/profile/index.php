...
<head>
  ...
  <!-- Favicons -->
  <link href="src=assets/img/Indramayu.png" alt="Gambar_Langit" style="width:50px;height:100px;" rel="icon">
  ...
  <header id="header" class="d-flex align-items-center">
    <div class="container d-flex align-items-center">
      ...
      <h5 class="logo me-auto"><a href="index.html">
          <h5><img src="assets/img/Indramayu.png" alt="logo_im" style="width:50px;height:100px;"> SISTEM INFORMASI DESA KENANGA</h5>
        </a></h5>
        ...
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>Layanan</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              ...
              <li><a href="admin/index.php">Pelayanan Mandiri</a></li>
            </ul>
          </li>
        </ul>
  ...
  <section id="hero">
    <div id="heroCarousel" data-bs-interval="5000" class="carousel slide carousel-fade" data-bs-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <!-- Slide 1 -->
        <div class="carousel-item active" style="background-image: url(assets/img/slide/slide-kantor.jpg)">
