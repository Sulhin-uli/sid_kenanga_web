      ...
      <div class="container max-w-5xl mx-auto m-8">
        ...
        <div class="w-full mb-4">
          ...
          <div class="sm:w-full px-6">
            ...
            Pengaduan Masyarakat adalah penyampaian keluhan, aspirasi dll yang ingin disampaikan oleh Masyarakat Desa Kenanga kepada pemerintah 
            Desa Kenanga, guna memperbaiki kekurangan atas kinerja dari pemerintah desa kenanga supaya ke depannya bisa lebih baik .
            </p>
          </div>
            ...
            <div class="px-3 py-5 bg-gray-100">
                <div class="sm:w-full px-6">
                    <h3 class="text-3xl text-gray-800 font-bold leading-none mb-3">
                        Aturan Pengaduan Masyarakat
                    </h3>
                    <p class="text-gray-600 mb-8">
                    1. Download Aplikasi .... di Playstore . </br>
                    2. Jika belum punya akun, harus melakukan registrasi . </br>
                    3. Setelah sudah punya akun silahkan login . </br>
                    4. Sesudah login silahkan pilih fitur pengaduan masyarakat di aplikasinya . </br>
                    5. Kemudian silahkan anda melakukan aspirasi dengan kata kata yang sopan .
                    </p>
                </div>
            </div>
        </div>
