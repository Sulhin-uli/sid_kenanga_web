      ...
      <div class="container max-w-5xl mx-auto m-8">
        ...
        <div class="w-full mb-4">
          ...
          <div class="sm:w-full px-6">
            ...
            Buat Surat adalah dimana penduduk desa kenanga bisa melakukan permintaan pembuatan surat kepada
            pemerintah desa kenanga secara online tanpa harus datang ke kantor, dimana fitur buat surat ini
            bertujuan untuk memudahkan masyarakat untuk melakukan permintaan pembuatan surat .
            </p>
          </div>
            ...
            <div class="px-3 py-5 bg-gray-100">
                <div class="sm:w-full px-6">
                    ...
                    4. Sesudah login silahkan pilih fitur surat di aplikasinya . </br>
                    5. Kemudian silahkan anda pilih surat apa yang ingin diajukan . </br>
                    6. Dan silahkan tunggu admin meminta data data melalui Whatsapp ke Anda .
                    </p>
                </div>
            </div>
        </div>
