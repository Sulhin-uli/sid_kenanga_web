      ...
      <div class="container mx-auto px-24">
        <div class="w-full flex flex-col md:flex-row py-6">
          ...
          <div class="flex-1">
            ...
            <ul class="list-reset mb-6">
              <li class="mt-2 inline-block mr-2 md:block md:mr-0">
                <a href="#" class="no-underline hover:underline text-gray-800 hover:text-pink-500">pemdeskenanga@gmail.com</a>
              </li>
            </ul>
          </div>
          <div class="flex-1">
            ...
            <ul class="list-reset mb-6">
              ...
              <li class="mt-2 inline-block mr-2 md:block md:mr-0">
                <a href="https://www.instagram.com/desakenanga_official/" class="no-underline hover:underline text-gray-800 hover:text-pink-500">Instagram</a>
              </li>
            </ul>
          </div>
        </div>
